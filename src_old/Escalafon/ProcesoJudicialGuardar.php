...
// Controllers
$procesoJudicialController = new ProcesoJudicialController;
...
try
{
	...
	if($archivoPermitido=="si"){
		...
		$idProcesoJudicial = (Int)$arrayParametrosInput->idProcesoJudicial;

		if ((Int)$arrayParametrosInput->idProcesoJudicial == 0)
		{

			$procesoJudicial = $procesoJudicialController->fncGuardar($arrayParametrosInput,$parametroArchivo);
			...
			if($procesoJudicial)
			{
				...
				$arrayReturn["data"]	= $procesoJudicial;
			}
			else
			{
		...
		else if ((Int)$arrayParametrosInput->idProcesoJudicial != 0)
		{
			$procesoJudicial = $procesoJudicialController->fncGuardar($arrayParametrosInput,$parametroArchivo);
