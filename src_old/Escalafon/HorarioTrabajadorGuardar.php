...
require_once('../../App/Escalafon/Controllers/HorarioTrabajadorController.php');
...
$clsHorarioTrabajadorController = new HorarioTrabajadorController();
...
if(fncGeneralValidarDataArray($arrayParametrosInput)){
	try{
		$dtGuardar = $clsHorarioTrabajadorController->fncGuardar($arrayParametrosInput);
		...
		if( fncGeneralValidarDataArray($dtGuardar[0]) ){
			...
			$arrayReturn['mensaje'] = 'Error en guardar los datos'. $dtGuardar[1];
