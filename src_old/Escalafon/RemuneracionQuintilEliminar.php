...
require_once("../../App/Escalafon/Controllers/RemuneracionQuintilController.php");
...
// Controllers
$remuneracionController = new RemuneracionQuintilController;
...
try
{
	if ($eliminado = $remuneracionController->fncEliminar($Api_id_get_first, $Api_id_get_second))
	{
