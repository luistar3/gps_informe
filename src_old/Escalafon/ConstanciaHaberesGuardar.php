...
require_once("../../App/Escalafon/Controllers/ConstanciaHaberesController.php");
...
// Controllers
$constanciaController = new ConstanciaHaberesController;
...
try
{
	if (!isset($input->id_constancia_haberes))
	{
		$constancia = $constanciaController->fncGuardar($input, $files);
	...
	else if (isset($input->id_constancia_haberes) && !empty($input->id_constancia_haberes))
	{
		$constancia = $constanciaController->fncActualizar($input, $files);
