...
$ClsTipoNivelEspecializacionController = new TipoNivelEspecializacionController();

//$arrayParametrosInput = json_decode(file_get_contents('php://input'));
try{
	$dtListarRegistros = $ClsTipoNivelEspecializacionController->fncListarRegistros($Api_id_get_first);
