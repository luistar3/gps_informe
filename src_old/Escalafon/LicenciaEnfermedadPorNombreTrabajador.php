...
$clsLicenciaEnfermedadController = new LicenciaEnfermedadController();

try{
	$dtListarRegistros = $clsLicenciaEnfermedadController->fncObtenerRegistroPorNombreTrabajador($Api_id_get_first);
