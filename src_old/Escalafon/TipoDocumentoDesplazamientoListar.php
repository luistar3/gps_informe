...
$clsTipoDocumentoDesplazamientoController = new TipoDocumentoDesplazamientoController();

try{
	$dtListarRegistros = $clsTipoDocumentoDesplazamientoController->fncListarRegistros($Api_id_get_first);
