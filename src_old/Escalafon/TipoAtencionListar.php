...
require_once('../../App/Escalafon/Controllers/TipoAtencionController.php');
...
$tipoAtencionController = new TipoAtencionController();

//$arrayParametrosInput = json_decode(file_get_contents('php://input'));
try{
	$dtListarRegistros = $tipoAtencionController->fncListarRegistros($Api_id_get_first);
