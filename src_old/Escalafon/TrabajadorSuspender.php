...
$clsActividad = new TrabajadorController();
//$hola = $_SERVER['PHP_AUTH_USER'];
try{
	$dtListarRegistros = $clsActividad->fncSuspenderTrabajador($Api_id_get_first);

	if(fncGeneralValidarDataArray($dtListarRegistros)){
		$arrayReturn['mensaje'] = 'Registros Actualizado con éxito';
