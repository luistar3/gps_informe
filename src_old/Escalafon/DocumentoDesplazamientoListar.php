...
$documentoDesplazamientoController = new DocumentoDesplazamientoController();

try{
	$dtListarRegistros = $documentoDesplazamientoController->fncRegistrosPorIdDesplazamiento($Api_id_get_first,$Api_id_get_second);
