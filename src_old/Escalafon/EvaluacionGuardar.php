...
try
{
	if (!isset($input->id_evaluacion))
	{
		$evaluacion = $evaluacionController->fncGuardar($input, $files);
	...
	else if (isset($input->id_evaluacion) && !empty($input->id_evaluacion))
	{
		$evaluacion = $evaluacionController->fncActualizar($input, $files);
