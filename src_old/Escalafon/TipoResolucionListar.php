...
require_once("../../App/Escalafon/Controllers/MeritoController.php");
...
// Controllers
$meritoController = new MeritoController;
...
try
{
	...
	//{
		$documento = $meritoController->fncListarTipoResolucion($Api_id_get_first);
