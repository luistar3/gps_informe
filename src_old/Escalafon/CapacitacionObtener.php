...
try
{
	...
	{
		/*$capacitaciones = $capacitacionController->fncObtenerCapacitacion();
		...
		$arrayReturn["data"]	= $motivos;*/

	}
	else if ($Api_id_get_first != -1)
	{
		$capacitacion = $capacitacionController->fncObtenerCapacitacion($Api_id_get_first);
