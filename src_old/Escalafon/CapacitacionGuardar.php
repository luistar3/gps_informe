...
if(fncGeneralValidarDataArray($arrayParametrosInput)){
	...
	//	if(fncValidarArchivo($parametroArchivo["name"])==0){ $archivoPermitida="no"; }
	//}
	try{
		$dtGuardar = $clsCapacitacionController->fncGuardarCapacitacion($arrayParametrosInput,$archivo);
