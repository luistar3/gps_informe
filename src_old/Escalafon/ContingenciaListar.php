...
require_once('../../App/Escalafon/Controllers/ContingenciaController.php');
...
$contingenciaController = new ContingenciaController();

//$arrayParametrosInput = json_decode(file_get_contents('php://input'));
try{
	$dtListarRegistros = $contingenciaController->fncListarRegistros($Api_id_get_first);
