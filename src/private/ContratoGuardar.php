...
try
{
	...
	{
		$contrato = $ContratoController->fncGuardar($input);
	...
	else if (isset($input->idContrato) && !empty($input->idContrato))
	{
		$contrato = $ContratoController->fncActualizar($input,$archivo);
