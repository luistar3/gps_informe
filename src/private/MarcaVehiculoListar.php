<?php
require_once('../../App/Controllers/MarcaVehiculoController.php');
...
$clsMarcaVehiculo = new MarcaVehiculoController();

try{
	$dtListarRegistros = $clsMarcaVehiculo->fncListarRegistros($Api_id_get_first);
