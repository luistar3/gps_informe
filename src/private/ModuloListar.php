...
require_once('../../App/Controllers/ModuloController.php');
...
$clsModuloController = new ModuloController();

try{
	$dtListarRegistros = $clsModuloController->fncListarRegistros($Api_id_get_first);
